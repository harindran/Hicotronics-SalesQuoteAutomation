Namespace SalesQuoteAutomation
    ...
    Public Class clsTable
        ...
        Public Sub HRMS_FieldCreation()
            SalesQuote()
            AddFields("OQUT", "RFQ", "RFQ", SAPbobsCOM.BoFieldTypes.db_Alpha, 10)
            AddFields("OITM", "OrderPN", "OrderPN", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("OITM", "Make", "Make", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("OITM", "SPQ", "SPQ", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("OITM", "Value", "Value", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("OITM", "MOQ", "MOQ", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("OITM", "LeadTime", "LeadTime", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("OQUT", "Date", "RFQ Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("QUT1", "CQTY", "CQTY", SAPbobsCOM.BoFieldTypes.db_Float, 6, SAPbobsCOM.BoFldSubTypes.st_Quantity)
            AddFields("QUT1", "Value", "Value", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            'AddFields("QUT1", "SQType", "SQ Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 3, , , "Regular", , {"Regular,Regular", "Online,Online"})
            'AddFields("QUT1", "SQType", "SQ Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 50)
        End Sub
...
#Region "Document Data Creation"
        ...
        Private Sub SalesQuote()
            AddTables("MIPL_SQUO", "SalesQuote Auto Header", SAPbobsCOM.BoUTBTableType.bott_Document)
            AddTables("MIPL_SQUO1", "SalesQuote Auto Lines", SAPbobsCOM.BoUTBTableType.bott_DocumentLines)

            AddFields("@MIPL_SQUO", "CustName", "Customer Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 200)
            AddFields("@MIPL_SQUO", "FName", "File Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 200)
            AddFields("@MIPL_SQUO", "AttachFile", "Attachment File", SAPbobsCOM.BoFieldTypes.db_Memo, 100, SAPbobsCOM.BoFldSubTypes.st_Link)
            AddFields("@MIPL_SQUO", "RFQDate", "RFQ Date", SAPbobsCOM.BoFieldTypes.db_Date)

            AddFields("@MIPL_SQUO1", "SItemcode", "SAP ItemCode", SAPbobsCOM.BoFieldTypes.db_Alpha, 200)
            AddFields("@MIPL_SQUO1", "SItemDesc", "SAP ItemDesc", SAPbobsCOM.BoFieldTypes.db_Alpha, 200)
            AddFields("@MIPL_SQUO1", "SMPN", "SAP MPN", SAPbobsCOM.BoFieldTypes.db_Alpha, 50)
            AddFields("@MIPL_SQUO1", "SMake", "SAP Make", SAPbobsCOM.BoFieldTypes.db_Alpha, 50)
            AddFields("@MIPL_SQUO1", "SDesc", "SAP Desc", SAPbobsCOM.BoFieldTypes.db_Alpha, 200)
            'AddFields("@MIPL_SQUO1", "SSPQ", "SAP SPQ", SAPbobsCOM.BoFieldTypes.db_Float, 6, SAPbobsCOM.BoFldSubTypes.st_Quantity)
            AddFields("@MIPL_SQUO1", "RFQQty", "RFQ QTY", SAPbobsCOM.BoFieldTypes.db_Float, 6, SAPbobsCOM.BoFldSubTypes.st_Quantity)
            AddFields("@MIPL_SQUO1", "Quantity", "Quantity", SAPbobsCOM.BoFieldTypes.db_Float, 6, SAPbobsCOM.BoFldSubTypes.st_Quantity)
            'AddFields("@MIPL_SQUO1", "UnitPrice", "Unit Price", SAPbobsCOM.BoFieldTypes.db_Float, 10, SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("@MIPL_SQUO1", "LeadTIme", "Lead Time", SAPbobsCOM.BoFieldTypes.db_Alpha, 100)
            'AddFields("@MIPL_SQUO1", "UPUSD", "UP USD", SAPbobsCOM.BoFieldTypes.db_Float, 10, SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("@MIPL_SQUO1", "Value", "Value", SAPbobsCOM.BoFieldTypes.db_Alpha, 200)
            AddFields("@MIPL_SQUO1", "CPN", "CPN", SAPbobsCOM.BoFieldTypes.db_Alpha, 200)
            AddFields("@MIPL_SQUO1", "Remarks", "Remarks", SAPbobsCOM.BoFieldTypes.db_Alpha, 200)
            AddFields("@MIPL_SQUO1", "SQType", "SQ Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 50)
            AddFields("@MIPL_SQUO1", "CusPrice", "Customer Price", SAPbobsCOM.BoFieldTypes.db_Float, 10, SAPbobsCOM.BoFldSubTypes.st_Sum)

            AddUDO("SQUO", "SalesQuote Auto", SAPbobsCOM.BoUDOObjType.boud_Document, "MIPL_SQUO", {"MIPL_SQUO1"}, {"DocEntry", "DocNum"}, True, True)
        End Sub
